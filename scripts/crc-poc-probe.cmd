<# :
@echo off
rem Double-click this file. It only reads information and changes nothing.
copy /y "%~f0" "%TEMP%\crc-poc-probe.ps1" >nul
powershell -NoProfile -ExecutionPolicy Bypass -File "%TEMP%\crc-poc-probe.ps1"
del "%TEMP%\crc-poc-probe.ps1" >nul 2>&1
echo.
echo Done. Send the crc-poc-*.json file from your Desktop to the Mac.
pause
exit /b
#>
[CmdletBinding()]
